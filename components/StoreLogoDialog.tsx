...
export function StoreLogoDialog({ visible, onClose }: Props) {
  const { t } = useLocale()
  ...
  function handleDismiss() {
    if (busy) return
    setBusy(true)
    markActionDismissed('store_logo_dialog')
    onClose()
  }
  ...
  function handleGo() {
    if (busy) return
    setBusy(true)
    markActionSeen('store_logo_dialog')
    onClose()
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text style={[styles.description, dirStyle]}>{t.storeLogoDialog.body}</Text>

              <View style={[styles.actionsRow, rowDir]}>
                <View style={styles.actionCell}>
                  <Button
                    label={t.storeLogoDialog.dismiss}
                    variant="outline"
                    size="lg"
